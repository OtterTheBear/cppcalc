...
the user wants to use positive or negative hyperoperations, only positive is
supported. It then asks for the degree of hyperoperation, supporting values from
0-4.
...
Currently, (v1.1) when the user chooses exponentiation, it asks wether they want
